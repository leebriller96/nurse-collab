...
**검사실 · 관리자 — 앉아서 여러 건을 동시에 본다**

<p align="center">
  <img src="docs/screenshots/exam-queue.png" width="49%" alt="검사실에 들어온 요청" />
  <img src="docs/screenshots/stats.png" width="49%" alt="검사실별 평균 대기시간" />
</p>
...
병동은 한 손으로 이동 중에 쓰고, 검사실은 앉아서 여러 건을 동시에 본다.
같은 반응형 화면을 늘렸다 줄이는 대신 레이아웃을 아예 나눴다.
